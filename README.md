...
> [Boyun Zheng](https://scholar.google.com/citations?user=ZveKOXkAAAAJ&hl=zh-CN), [Yu Jiang](https://scholar.google.com/citations?user=P9_bgvEAAAAJ&hl=en), Dejun Fan, [Xinyu Liu](https://xinyuliu-jeffrey.github.io/), [Xiaoqing Guo](https://guo-xiaoqing.github.io/), [Shengyuan Liu](https://scholar.google.com/citations?user=zP6fRqcAAAAJ), Bin Chen, Mingjie Wang, Jinni Luo, Jin Tao<sup>✉</sup>, Jiancong Hu<sup>✉</sup>, [Lichao Sun](https://lichao-sun.github.io/), [Lei Xing](https://profiles.stanford.edu/lei-xing), [Yixuan Yuan](https://www.ee.cuhk.edu.hk/~yxyuan/people/people.htm)<sup>✉</sup>

![introduction](assets/introduction.jpg)

## 📄 Introduction

Gastrointestinal (GI) diseases persist as a significant global health burden due to elevated morbidity and mortality. Accurate and timely diagnosis, especially for small bowel conditions, remains challenging due to the complexity and lengthy duration (6-12 hours) of capsule endoscopy (CE) videos, which require approximately 1.5 hours of manual review. While artificial intelligence (AI) systems have enhanced CE analysis, seamlessly integrated AI-driven diagnostic report generation, a key clinical need, remains largely unexplored. In this study, we establish the MICS-CE dataset, the first large-scale resource for automated CE report generation. It includes 109 million frames spanning 11,028 hours of video and features 29,338 gastroenterologist-annotated keyframe–text pairs, derived from 1,002 video–report pairs collected across four clinical centers using three capsule devices. Building on this foundation, we developed CE Reporter, the first dedicated, explainable system for CE reporting, which transforms lengthy videos into concise, evidence-supported diagnostic reports through vision–language integration. CE Reporter achieves superior performance across three key dimensions: (1) Report quality: high linguistic coherence and diagnostic accuracy (BLEU score: 0.573, F1-score: 0.82 for multi-lesion detection); (2) Clinician evaluation: high correctness, completeness, and conciseness, with reporting time reduced by 91.9% for small bowel segments and 97.3% for complete gastrointestinal videos relative to resident clinicians; (3) Clinical utility: explainable reports supported by visual keyframes and robust performance across centers and devices (F1-score: 0.72–0.81). By unifying a unique, large-scale dataset with a dedicated, explainable model, our work provides the first practical solution for automated CE reporting, markedly improving efficiency and transparency in AI-driven GI diagnostics.
